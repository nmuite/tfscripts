...
# USAGE:
#   chmod +x aws_inventory_v4.sh
#   ./aws_inventory_v4.sh                          # default profile + configured region
#   ./aws_inventory_v4.sh --profile myprofile      # named profile
#   ./aws_inventory_v4.sh --region eu-west-1       # explicit region (repeatable)
#   ./aws_inventory_v4.sh --all-regions            # scan every enabled region
#   ./aws_inventory_v4.sh --concurrency 4          # parallel region workers (default 4)
#   ./aws_inventory_v4.sh --no-import-blocks       # skip imports.tf generation
# =============================================================================
...
# ── Auth check ────────────────────────────────────────────────────────────────
echo -e "${BOLD}${CYAN}┌─────────────────────────────────────────────────┐${NC}"
echo -e "${BOLD}${CYAN}│   AWS Infrastructure Inventory Tool  (v4)       │${NC}"
echo -e "${BOLD}${CYAN}└─────────────────────────────────────────────────┘${NC}"
echo ""
